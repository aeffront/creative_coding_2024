async function loadSVGAndExtractPoints(filePath) {
    try {
      ...
      paths.forEach((path) => {
        ...
        const numPoints = 1000; // Number of points to sample
  ...
  // Usage Example
  const filePath = "./path/to/your/file.svg"; // Replace with your SVG file's path
  loadSVGAndExtractPoints(filePath).then((points) => {
